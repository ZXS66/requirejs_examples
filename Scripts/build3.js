...
This build will use statically provided has values, look in the source code and you will see statements like
has("DEBUG")
replaced with:
true
or
false
depending on the values in the has object (see below)
